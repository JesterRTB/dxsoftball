                ...
                with tab_gl_batting:
                    st.dataframe(
                        ...
                        column_config={
                            ...
                            "triples": st.column_config.NumberColumn("3B", width=40, format="%d"),
                            "home_runs": st.column_config.NumberColumn("HR", width=40, format="%d"),
                            "runs": st.column_config.NumberColumn("R", width=40, format="%d"),
                            "runs_batted_in": st.column_config.NumberColumn("RBI", width=40, format="%d"),
                            "walks": st.column_config.NumberColumn("BB", width=40, format="%d"),
                            "strikeouts_batting": st.column_config.NumberColumn("SO", width=40, format="%d"),
                            ...
                            "total_bases": st.column_config.NumberColumn("TB", width=40, format="%d"),
                            "sacrifice_flies": st.column_config.NumberColumn("SF", width=40, format="%d"),

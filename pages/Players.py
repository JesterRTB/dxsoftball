    ...
    if not df.empty:
        ...
        with col_bio:
            ...
            if has_jersey_data:
                ...
                name_style = "color: #FFFFFF; font-size: 11px; text-transform: uppercase; letter-spacing: 1px; padding: 0 4px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 140px;"
